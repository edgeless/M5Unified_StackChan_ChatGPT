...
WhisperRest::WhisperRest(/* args */) {
}

WhisperRest::~WhisperRest() {
}

int WhisperRest::gettoken(void) {
    HTTPClient gettoken;
...
void WhisperRest::settoken(String token_str) {
    api_token_str = token_str;
}

String WhisperRest::Str2UrlEncode(String str) {
    String strout = "";
...
int WhisperRest::Pcm2String(uint8_t* pcm_buff, uint32_t pcm_lan, String dev_pid,
                          String* results_str) {
...
int WhisperRest::String2Pcm(String str, int spd, int pit, int vol, int per,
