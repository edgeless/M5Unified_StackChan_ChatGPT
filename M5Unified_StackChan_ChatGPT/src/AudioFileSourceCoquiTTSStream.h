...
class AudioFileSourceCoquiTTSStream : public AudioFileSourceVoiceTextStream
{
  friend class AudioFileSourceICYStream;

  public:
    AudioFileSourceCoquiTTSStream();
    AudioFileSourceCoquiTTSStream(const char *tts_text, const char *tts_parms);
    virtual ~AudioFileSourceCoquiTTSStream() override;
